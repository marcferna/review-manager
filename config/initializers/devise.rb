...
Devise.setup do |config|
  ...
  config.secret_key = 'pargvbgeawwbcsp3fqgcf46juftpnamxx6essd9vmps8g5ezw63mhsj'\
    '7syd4w5z8tuqmgvr49p7adprdzus6zta3gxjqt7sq84zmtzbe36bbmg4dbrqceb6xzknz95pr'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'mailer@review-manager.com'
  ...
  # for th given strategies, for example,
  ...
  # `config.http_authenticatable = [:database]` will enable it only for database
  ...
  # (the default algorithm), the cost increases exponentially with the number of
  # stretches (e.g. a value of 20 is already extremely slow: approx. 60 seconds
  # for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = '08137d46f25334924f9a912c8fe2ff012e44d8e116ba87d53b1447629'\
  #   '753c94c4c27b8b21317336606aa774e2d91789af1940283e969627b1837d37194087135'
  ...
  # initial account confirmation) to be applied. Requires additional unconfirmed
  # _email db field (see migrations). Until confirmed, new email is stored in
